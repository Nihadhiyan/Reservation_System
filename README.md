...
- **Rate limiting**: A dedicated filter applies rate limiting after JWT authentication, to protect authenticated endpoints from abuse.#  Reservation System — Backend
